        ...
        <div class="container my-5">
            ...
            <form action="/codingblogwebsite/contact.php" method="post">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="name" name="name" aria-describedby="emailHelp" placeholder="Enter your full name">
                </div>
                <div class="mb-3">
                    <label for="email" class="form-label">Email address</label>
                    <input type="email" class="form-control" id="email" name="email" aria-describedby="emailHelp" placeholder="Enter your valid email">
                    <div id="emailHelp" class="form-text">We'll never share your email with anyone else.</div>
                </div>
                <div class="mb-3">
                    <label for="querySelect" class="form-label">Query</label>
                    <select class="form-select form-select-sm" id="querySelect" name="querySelect" aria-label=".form-select-sm example">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="desc" name="desc" cols="30" rows="10" placeholder="Enter your concern"></textarea>
                </div>
